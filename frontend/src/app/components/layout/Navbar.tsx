    ...
    <nav className="sticky top-0 z-50 bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-8">
          <Link
            to="/"
            className="min-w-24 shrink-0 text-2xl font-light tracking-wider text-neutral-900 dark:text-white"
          >
            BKQ
          </Link>
          ...
          <div className="hidden md:flex items-center gap-10">
            <Link
              ...
              className="whitespace-nowrap text-sm tracking-wide hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors"
            >
              NỮ
            </Link>
            <Link
            ...
            <Link
              to="/danh-cho-ban"
              className="flex items-center gap-1 whitespace-nowrap text-sm tracking-wide hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors"
            >
          ...
          <div className="flex items-center space-x-4">
            ...
            {isLoggedIn ? (
              <div className="hidden md:flex items-center gap-2">
                <Link
                  to={role === "admin" ? "/portal-admin/products" : "/profile"}
                  className="flex h-10 max-w-44 items-center gap-2 rounded-full border border-neutral-200 bg-white px-3 text-sm text-neutral-900 transition-colors hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 dark:hover:bg-neutral-800"
                ...
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border border-neutral-200 bg-white text-[0px] text-neutral-900 transition-colors hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 dark:hover:bg-neutral-800"
