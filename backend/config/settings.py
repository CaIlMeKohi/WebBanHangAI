...
FRONTEND_PUBLIC_URL = _env('FRONTEND_PUBLIC_URL', 'http://127.0.0.1:5173').rstrip('/')
PAYOS_CLIENT_ID = _env('PAYOS_CLIENT_ID')
PAYOS_API_KEY = _env('PAYOS_API_KEY')
PAYOS_CHECKSUM_KEY = _env('PAYOS_CHECKSUM_KEY')
PAYOS_RETURN_URL = _env('PAYOS_RETURN_URL', f'{FRONTEND_PUBLIC_URL}/payment/result')
PAYOS_CANCEL_URL = _env('PAYOS_CANCEL_URL', f'{FRONTEND_PUBLIC_URL}/payment/result')
PAYOS_WEBHOOK_URL = _env('PAYOS_WEBHOOK_URL')
PAYOS_PAYMENT_TIMEOUT_MINUTES = int(_env('PAYOS_PAYMENT_TIMEOUT_MINUTES', '15'))
